...
export const metadata = {
  ...
  description:
    "Inquire about original artwork, canvas prints, and special requests at Shamrock Art Studio.",
};
      ...
      <div className="flex flex-col gap-8 lg:flex-row lg:items-start lg:gap-12 w-full">
        <div className="min-w-0 flex-11 space-y-6">
          <p className="leading-relaxed text-stone-200/95 sm:leading-8">
            Get in touch with Shamrock Art Studio for questions about original artwork, canvas prints, special requests, availability, or shipping. We welcome inquiries from collectors, gift buyers, and anyone interested in learning more about the artist’s work.
            <br />
            <br />
