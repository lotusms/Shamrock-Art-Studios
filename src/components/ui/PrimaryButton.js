...
const BASE_CLASSES =
  "inline-flex items-center justify-center gap-2 rounded-full px-6 py-3.5 text-sm font-semibold text-slate-900 shadow-lg shadow-slate-900/35 ring-2 ring-white/30 transition duration-300 ease-out hover:-translate-y-0.5 hover:shadow-xl hover:shadow-slate-900/40 active:translate-y-0 disabled:cursor-not-allowed disabled:opacity-60 min-w-fit";
